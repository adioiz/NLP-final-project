...
def main():
    ...
    plot_confusion_matrix(history["best_labels"], history["best_preds"], "BERT", save_path="outputs/bert_confusion_matrix.png")
    ...
    print("\nResults saved to outputs/bert_results.json")

    print(f"\nBest model saved to: {WEIGHTS_DIR}/bert_best.pt")
