...
def main():
    ...
    plot_confusion_matrix(history["best_labels"], history["best_preds"], "RoBERTa", save_path="outputs/roberta_confusion_matrix.png")
    ...
    print("\nResults saved to outputs/roberta_results.json")

    print(f"\nBest model saved to: {WEIGHTS_DIR}/roberta_best.pt")
